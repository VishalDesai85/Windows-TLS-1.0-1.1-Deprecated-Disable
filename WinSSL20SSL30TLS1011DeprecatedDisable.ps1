...
$SSL20ClientKey = "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\SSL 2.0\Client"
$SSL20ClientName = "Enabled"
$SSL20ClientExists = Test-RegistryValue -Path $SSL20ClientKey -Name $SSL20ClientName 
Update-RegistryValue -Exists $SSL20ClientExists -Path $SSL20ClientKey -Name $SSL20ClientName 

<#
# Disable SSL 2.0 Server
#>

$SSL20ServerKey = "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\SSL 2.0\Server"
$SSL20ServerName = "Enabled"
$SSL20ServerExists = Test-RegistryValue -Path $SSL20ServerKey -Name $SSL20ServerName
Update-RegistryValue -Exists $SSL20ServerExists -Path $SSL20ServerKey -Name $SSL20ServerName
...
$SSL30ServerKey = "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\SSL 3.0\Server"
$SSL30ServerName = "Enabled"
$SSL30ServerExists = Test-RegistryValue -Path $SSL30ServerKey -Name $SSL30ServerName
Update-RegistryValue -Exists $SSL30ServerExists -Path $SSL30ServerKey -Name $SSL30ServerName
